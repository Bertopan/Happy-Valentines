document.addEventListener("DOMContentLoaded", () => {
    ...
    const flowersData = [
        ...
        { id: 10, x: 350, y: 400, color: '#aa0000', msg: "You must be Akainu, because you just left a permanent hole in my heart and it’s definitely not because of the character development." },
